...
6. **فلتر المكان (Location):** الوظيفة تعدّي بس لو مكانها:
   - **الخليج:** السعودية/الرياض/جدة، الإمارات/دبي/أبوظبي، قطر/الدوحة، الكويت،
     عُمان/مسقط، البحرين.
   - **مصر:** Egypt / Cairo.
   - **مناطق الشرق الأوسط:** EMEA, MENA, Middle East, GCC, Gulf, Arab world,
     Arab region.
   - **ريموت مفتوح عالميًا:** Remote / Worldwide / Anywhere / Global (من غير
     تقييد دولة).

   **قاعدة أولوية:** لو مكان أو **وصف** الوظيفة فيه أي من
   (EMEA / MENA / Middle East / Gulf / GCC / Egypt)، البوت بيقبلها **حتى لو
   فيها ذكر لأوروبا أو أمريكا** (لأن المناطق دي بتشمل مصر والخليج).

   وبتترفض بس لو مقيّدة لـ **أوروبا أو أمريكا من غير أي ذكر للشرق
   الأوسط/مصر/الخليج** (زي `Europe only`، `EU only`، `Remote US`،
   `Remote – Netherlands`، `Amsterdam`، `New York`، `Germany` … أو أي مدينة
   أوروبية/أمريكية).
